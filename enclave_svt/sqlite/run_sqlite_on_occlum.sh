...
run_sqlite() {
    ...
    occlum run /usr/lib/jvm/enclave_svt/jre/bin/java -classpath ".:sqlite-jdbc-3.6.7.jar" -Xmx512m -XX:-UseCompressedOops -XX:MaxMetaspaceSize=64m -Dos.name=Linux /usr/lib/sqlite/${jar_file}
}
